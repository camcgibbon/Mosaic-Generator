...
tile_images_dir = "../../MMGs/vaporwave/tile_images_vaporwave/"
tile_image_count = len(os.listdir(tile_images_dir))

response = requests.put('http://127.0.0.1:5000/addMMG', data={"name": "vaporwave-mmg", "url": "http://127.0.0.1:5001/makeMosaic/", "author": "Connor McGibbon", "tileImageCount": tile_image_count})

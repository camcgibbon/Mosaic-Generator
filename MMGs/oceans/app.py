...
tile_images_dir = "../../MMGs/oceans/tile_images_oceans"
tile_image_count = len(os.listdir(tile_images_dir))

response = requests.put('http://127.0.0.1:5000/addMMG', data={"name": "oceans-mmg", "url": "http://127.0.0.1:5004/makeMosaic/", "author": "Connor McGibbon", "tileImageCount": tile_image_count})

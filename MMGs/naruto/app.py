...
tile_images_dir = "../../MMGs/naruto/tile_images_naruto/"
tile_image_count = len(os.listdir(tile_images_dir))

response = requests.put('http://127.0.0.1:5000/addMMG', data={"name": "naruto-mmg", "url": "http://127.0.0.1:5005/makeMosaic/", "author": "Connor McGibbon", "tileImageCount": tile_image_count})

...
tile_images_dir = "../../MMGs/dogs/tile_images_dogs/"
tile_image_count = len(os.listdir(tile_images_dir))

response = requests.put('http://127.0.0.1:5000/addMMG', data={"name": "dogs-mmg", "url": "http://127.0.0.1:5007/makeMosaic/", "author": "Connor McGibbon", "tileImageCount": tile_image_count})

...
tile_images_dir = "../../MMGs/abstract_art/tile_images_abstract_art/"
tile_image_count = len(os.listdir(tile_images_dir))

response = requests.put('http://127.0.0.1:5000/addMMG', data={"name": "abstract_art-mmg", "url": "http://127.0.0.1:5009/makeMosaic/", "author": "Connor McGibbon", "tileImageCount": tile_image_count})

...
tile_images_dir = "../../MMGs/colors/tile_images_colors/"
tile_image_count = len(os.listdir(tile_images_dir))

response = requests.put('http://127.0.0.1:5000/addMMG', data={"name": "colors-mmg", "url": "http://127.0.0.1:5008/makeMosaic/", "author": "Connor McGibbon", "tileImageCount": tile_image_count})

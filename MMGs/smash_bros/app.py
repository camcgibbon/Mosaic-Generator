...
tile_images_dir = "../../MMGs/smash_bros/tile_images_smash_bros/"
tile_image_count = len(os.listdir(tile_images_dir))

response = requests.put('http://127.0.0.1:5000/addMMG', data={"name": "smash_bros-mmg", "url": "http://127.0.0.1:5002/makeMosaic/", "author": "Connor McGibbon", "tileImageCount": tile_image_count})

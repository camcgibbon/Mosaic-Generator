...
tile_images_dir = "../../MMGs/plants/tile_images_plants/"
tile_image_count = len(os.listdir(tile_images_dir))

response = requests.put('http://127.0.0.1:5000/addMMG', data={"name": "plants-mmg", "url": "http://127.0.0.1:5003/makeMosaic/", "author": "Connor McGibbon", "tileImageCount": tile_image_count})
